    ...
    <div class="container">
        <div class="row gy-4 d-flex justify-content-center">
            <div class="col-md-9 grid-margin stretch-card d-flex justify-content-center">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Notify to all members for this company</h4>
                        <form method="POST" action="{{ route('notification.company.all.send',['companyId' => request('companyId')]) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-4">
                                <div class="form-floating">
                                    <textarea class="form-control" id="floatingTextarea2" name="message" placeholder="Enter your message" autocomplete="off" style="height: 100px">{{ old('message') }}</textarea>
